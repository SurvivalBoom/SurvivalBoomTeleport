package net.survivalboom.survivalboomteleport.utils;
...
public class Utils {
    ...
    private static final JavaPlugin plugin = SurvivalBoomTeleport.getPlugin();
    ...
    public static void sendPluginError(@NotNull String msg, @NotNull Exception e) {
        ...
        PluginMessages.consoleSend("&cSurvivalBoomTeleport &8&l► &f: " + msg);
    ...
    public static Component componentReplace(@NotNull Component in, @NotNull String replacement, @NotNull String value) {
        ...
        SurvivalBoomTeleport.getPlugin().getLogger().warning(serialised);
