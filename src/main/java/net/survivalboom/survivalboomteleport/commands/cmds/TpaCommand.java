...
public class TpaCommand {
    ...
    public static void command(@NotNull CommandSender sender, @NotNull String[] args) {
        ...
        if (!sender.hasPermission("sbteleport.tpa")) {
            PluginMessages.sendMessage(sender, PluginMessages.getMessage("no-permission").replace("{PERMISSION}", "sbteleport.tpa"));
            return;
        }
        ...
        if (playerName == null) {
            PluginMessages.sendMessage(sender, PluginMessages.getMessage("tpa-usage"));
            return;
        }
        ...
        if (target.equals(player)) {
            PluginMessages.sendMessage(sender, PluginMessages.getMessage("tpa-self"));
            return;
        }
        ...
        TeleportManager.requestToPlayer(player, target, false);
        ...
        Component component = PluginMessages.parse(placeholders.parse(PluginMessages.getMessage("teleport-request-msg")));
